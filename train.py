...
# ageModel.load_weights('./checkpoints/age_check')
...
for _ in range(train_times):
    ...
    for i in range(10):
        ...
        ageModel.fit(trainX, trainY, epochs=10, batch_size=32, validation_data=(testX, testY))

ageModel.save_weights('./checkpoints/age_check_Jan_6_12_44')
